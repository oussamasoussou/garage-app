                        ...
                        <div class="intro-y box lg:mt-5">
                            <div class="flex items-center p-5 border-b border-gray-200 dark:border-dark-5">
                                <h2 class="font-medium text-base mr-auto">
                                    Modifier les données du mécanicien.
                                </h2>
                            </div>
                            <div class="p-5">
                            <form class="validate-form" action="{{ url('update-mecanicien/'.$mecaniciens->id) }}" method="POST">
                            @csrf 
                            @method('PUT')
                                        ...
                                        <div class="col-span-12 xl:col-span-8">
                                            <div class="input-form">
                                                ...
                                                <input type="text" name="nom" class="input w-full border mt-2"
                                                    placeholder="Veuillez entrer le nom du mecanicien." minlength="2" value="{{ $mecaniciens->nom }}">
                                            </div>
                                            <div class="input-form mt-3">
                                                ...
                                                <input type="text" name="prenom" class="input w-full border mt-2"
                                                    placeholder="Veuillez entrer le prénom du mecanicien." minlength="2" value="{{ $mecaniciens->prenom }}">
                                            </div>
                                            <div class="input-form mt-3">
                                                ...
                                                <input type="number" name="telephone" class="input w-full border mt-2"
                                                    placeholder="Veuillez entrer le numéro de téléphone du mecanicien." value="{{ $mecaniciens->telephone }}">
                                            </div>
                                            <div class="input-form mt-3">
                                                ...
                                                <input type="number" name="identite" class="input w-full border mt-2"
                                                    placeholder="Veuillez entrer le numéro de identité du mecanicien." value="{{ $mecaniciens->identite }}">
                                            </div>
