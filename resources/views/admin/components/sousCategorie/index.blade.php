...
<div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 lg:col-span-4 xxl:col-span-3 flex lg:block flex-col-reverse">
                        <div class="intro-y box mt-5">
                            ...
                            <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                                <a class="flex items-center text-theme-1 dark:text-theme-10 font-medium" href="{{ url('sousCategories') }}"> <i data-feather="list" class="w-4 h-4 mr-2"></i> Liste des sous-catégories </a>
                    ...
                    <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
                     @foreach ($sousCategoriesGroupedByCategorie as $categorieId => $sousCategories)


                        <div class="intro-y box mt-5">
                                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                @php
                                    $categorie = $sousCategories->first()->categorie; // Prend la première sous-catégorie de la catégorie
                                @endphp
                                    <h2 class="font-medium text-base mr-auto">
                                    Liste des catégories <span style="color:#d32929 !important">{{ $categorie->libelle }}</span>
                                    </h2>
                                </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($sousCategories as $sousCategorie)
                                                            <tr class="bg-gray-200 dark:bg-dark-1">
                                                                <td class="border-b dark:border-dark-5">{{ $sousCategorie->id }}</td>
                                                                <td class="border-b dark:border-dark-5">{{ $sousCategorie->libelle }}</td>
                                                                <td class="table-report__action w-56">
                                                                    <div class="flex justify-center items-center">
                                                                        <a class="flex items-center mr-3" style="color: #03660c;" href="{{ url('edit-sousCategorie/'.$sousCategorie->id) }}"> <i data-feather="check-square"
                                                                                class="w-4 h-4 mr-1"></i> <span style="color: #03660c;">Modifier</span>  </a>
                                                                        <a class="flex items-center text-theme-6" href="{{ url('delete-sousCategorie/'.$sousCategorie->id) }}" data-toggle="modal"
